...
const demoItems: CardItem[] = [
  {
    ...
    tags: ['data', 'sql', 'ai'],
    meta: [
      { label: '1.2k', icon: <Star className="h-3 w-3" /> },
      { label: '89', icon: <GitFork className="h-3 w-3" /> },
      { label: '2h ago' },
    ],
  },
  {
    ...
    tags: ['ui', 'shadcn'],
    meta: [
      { label: '847', icon: <Star className="h-3 w-3" /> },
      { label: '62', icon: <GitFork className="h-3 w-3" /> },
      { label: '4h ago' },
    ],
  },
  {
    ...
    tags: ['ml', 'pipeline'],
    meta: [
      { label: '3.4k', icon: <Star className="h-3 w-3" /> },
      { label: '241', icon: <GitFork className="h-3 w-3" /> },
      { label: '1d ago' },
    ],
  },
  {
    ...
    meta: [
      { label: '2.1k', icon: <Star className="h-3 w-3" /> },
      { label: '97', icon: <GitFork className="h-3 w-3" /> },
      { label: '3d ago' },
    ],
  },
  {
    ...
    meta: [
      { label: '678', icon: <Star className="h-3 w-3" /> },
      { label: '45', icon: <GitFork className="h-3 w-3" /> },
      { label: '5d ago' },
    ],
  },
  {
    ...
    tags: ['auth', 'security'],
    meta: [
      { label: '521', icon: <Star className="h-3 w-3" /> },
      { label: '38', icon: <GitFork className="h-3 w-3" /> },
      { label: '1w ago' },
    ],
  },
  {
    ...
    meta: [
      { label: '389', icon: <Star className="h-3 w-3" /> },
      { label: '27', icon: <GitFork className="h-3 w-3" /> },
      { label: '2w ago' },
    ],
  },
  {
    ...
    meta: [
      { label: '294', icon: <Star className="h-3 w-3" /> },
      { label: '19', icon: <GitFork className="h-3 w-3" /> },
      { label: '3w ago' },
    ],
  },
]
